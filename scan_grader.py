...
def decide_tensakit_marks(
    ...
    content.append({
        ...
        "text": (
            ...
            "・記号選択(生徒の回答: ア〜ク・未回答 等のラジオ)がある設問: 答案の該当する解答欄"
            "(記号 a,b,c… や小問番号で対応)を見て、生徒が実際に書いた記号(ア/イ/ウ…)を読み取り、"
            "その記号の選択肢 index を radio_index に1つだけ入れる。はっきり記入があるのに『未回答』を"
            "選んではいけない。解答欄が明らかに空欄のときだけ『未回答』の index にする。\n"
